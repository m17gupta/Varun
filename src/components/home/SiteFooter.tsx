...
export function SiteFooter() {
  return (
    <footer className="bg-dark px-6 py-16 text-card sm:py-20 lg:px-12">
      <div className="mx-auto max-w-[1400px]">
        {/* Centered CTA */}
        <div className="mx-auto max-w-2xl text-center pb-14 border-b border-white/10">
          ...
          <form className="mt-8 mx-auto flex max-w-md border-b border-white/20">
            ...
            <input
              ...
              className="min-w-0 flex-1 bg-transparent py-3 text-sm text-card placeholder:text-white/30 focus:outline-none"
            />
            <button
              type="submit"
              className="py-3 px-4 text-[10px] font-bold uppercase tracking-[0.2em] text-white/60 transition-colors duration-300 hover:text-card"
            >
              Subscribe
            </button>
          </form>
        ...
        {/* Middle: Name + Links */}
        <div className="grid gap-10 pt-14 lg:grid-cols-[1.4fr_1fr_1fr]">
          <div>
          ...
          <nav className="grid gap-3 text-sm text-white/40">
            <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.26em] text-white/40">
              Index
            </p>
