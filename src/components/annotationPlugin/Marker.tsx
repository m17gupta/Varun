...
export const Marker: React.FC<MarkerProps> = ({ annotation }) => {
  ...
  const handleScreenChange = (screenSize: ScreenSize) => {
    ...
    >
      <div
        ...
        className={`absolute -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full shadow-lg flex items-center justify-center text-white transition-transform ${
          isActive
            ? `${config.color.split(' ')[0]} scale-110 ring-4 ${config.color.split(' ')[1]}`
            : `${config.color.split(' ')[0]} hover:scale-110`
            ...
            <div className="bg-slate-50 px-4 py-3 border-b border-slate-100 flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    e.stopPropagation();
                    handleStatusChange(e.target.value as CommentStatus);
                  }}
              ...
              <div className="flex items-center gap-1">
                <div className="flex items-center gap-1 text-slate-400 mr-2" title="Visible on screen size">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      e.stopPropagation();
                      handleScreenChange(e.target.value as ScreenSize);
                    }}
            ...
            <div className="px-4 py-2 border-t border-slate-100 flex justify-between items-center">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md bg-indigo-600 px-2.5 py-1.5 text-xs font-semibold text-white transition hover:bg-indigo-700"
